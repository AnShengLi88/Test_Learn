...
public class PageView : MonoBehaviour, IBeginDragHandler, IEndDragHandler
{
    ...
    public void Init(int count , List<GameObject> toggleList)
    {
        AlbumCount = count;
        ToggleList = toggleList;
        var _rectWidth = GetComponent<RectTransform>();
        var tempWidth = ((float)count * _rectWidth.rect.width);
    ...
    {
        var toogle = ToggleList[index].GetComponent<Toggle>();//toggleList.GetChild(index).GetComponent<Toggle>();
        toogle.isOn = true;
    }
}